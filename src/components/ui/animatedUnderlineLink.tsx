  ...
  return (
    <div className='group relative inline-block h-7 overflow-hidden'>
      ...
      >
        ...
        <span
          className='
            absolute left-0 top-full h-[0.125rem] w-full border-black border-b transition-transform duration-700 ease-in-out transform -translate-x-[200%] group-hover:translate-x-0'
        />
      </Link>
    </div>
  );
